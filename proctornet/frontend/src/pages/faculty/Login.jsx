...
export default function FacultyLogin() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Enter your institutional email and password to access the faculty workspace."
      heroHeadline="Faculty Login"
      heroSubtitle="Sign in to author papers, generate AI questions, and evaluate assessments."
      personImage="/login-faculty.jpg"
      switchRoleLink={{ label: 'Student Login', path: '/student/login' }}
      registerLink={null}
    >
