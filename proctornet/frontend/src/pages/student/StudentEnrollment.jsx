  ...
  return (
    <DashboardLayout title="Mandatory Biometric Verification">
      <div className="max-w-4xl mx-auto py-4 space-y-6 font-sans">
        ...
        <Card className="bg-[#141416] border-[#27272A] p-6 sm:p-8 shadow-xl">
          {/* Progress Stepper */}
          <div className="grid grid-cols-4 gap-2 mb-8 pb-6 border-b border-[#27272A]">
            {[
                ...
                <div key={s.id} className="flex flex-col items-center gap-2">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center font-bold text-xs transition-all ${
                      isDone
                        ...
                        : 'bg-[#09090B] text-slate-500 border border-[#27272A]'
                    }`}
                  >
                  ...
                  <span
                    className={`text-[11px] font-mono text-center hidden sm:block ${
                      isActive ? 'text-slate-100 font-bold' : isDone ? 'text-emerald-400' : 'text-slate-500'
                    }`}
                  >
                    {s.name}
                  </span>
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h2 className="text-sm font-bold text-slate-100">Biometric Data Consent & Privacy Disclosure</h2>
                <div className="text-xs text-slate-300 space-y-3 leading-relaxed bg-[#09090B] p-5 rounded-xl border border-[#27272A] font-mono">
                  <p>
                    <strong className="text-slate-100">What Data is Collected:</strong> Live webcam selfie photo, vector face embeddings, and institutional ID card document.
                  </p>
                  <p>
                    <strong className="text-slate-100">How it is Used:</strong> Face embeddings are processed locally via self-hosted Exadel CompreFace (ArcFace AI) to verify your identity during exam check-in and prevent candidate impersonation.
                  </p>
                  <p>
                    <strong className="text-slate-100">Privacy Guarantee:</strong> No data is transmitted to commercial third-party cloud APIs. All vector data remains encrypted on institution servers.
                  </p>
                </div>

                <label className="flex items-start gap-3 p-4 rounded-xl bg-[#09090B] border border-[#27272A] cursor-pointer hover:border-[#3F3F46] transition">
                  <input
                    type="checkbox"
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                <h2 className="text-sm font-bold text-slate-100">Step A: Live Face Reference Enrollment</h2>
                <p className="text-xs text-slate-400 mt-0.5">
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="relative w-full max-w-md aspect-[4/3] rounded-2xl overflow-hidden bg-[#09090B] border border-[#27272A] flex items-center justify-center">
                  {!capturedSelfie ? (
                    <>
                      <video
                        ref={videoRef}
                      ...
                      />
                      <div className="absolute inset-0 border-2 border-indigo-500/40 rounded-full m-8 pointer-events-none border-dashed animate-pulse" />
                    </>
                  ) : (
              ...
              <div className="flex justify-between items-center pt-4 border-t border-[#27272A]">
                <Button
                  onClick={() => setStep(1)}
                  variant="outline"
                  className="text-xs font-mono border-[#27272A] bg-[#09090B] text-slate-300"
                >
                  Back
                </Button>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                <h2 className="text-sm font-bold text-slate-100">Step B: Institutional / Government ID Verification</h2>
                <p className="text-xs text-slate-400 mt-0.5">
              ...
              <div className="space-y-4">
                {!idPreview ? (
                  <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-[#27272A] hover:border-indigo-500 rounded-2xl bg-[#09090B] cursor-pointer transition p-6">
                    <Upload className="w-8 h-8 text-slate-400 mb-2" />
                    <span className="text-xs font-semibold text-slate-200">Click to upload ID Card Image</span>
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <div className="relative w-full max-w-md h-48 rounded-xl overflow-hidden border border-[#27272A] bg-[#09090B]">
            ...
            <div className="text-center py-6 space-y-6">
              {user?.profileStatus === 'VERIFIED' || user?.profileStatus === 'LOCKED' ? (
                <div className="space-y-4">
                  ...
                  <h2 className="text-xl font-bold text-slate-100">Biometric Profile Verified & Locked</h2>
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      className="text-xs font-mono font-bold bg-indigo-600 hover:bg-indigo-500 text-white px-6"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-xl font-bold text-slate-100">Biometric Verification Rejected</h2>
                ...
                <div className="space-y-4">
                  ...
                  <h2 className="text-xl font-bold text-slate-100">Biometric Enrollment Under Review</h2>
                  <p className="text-xs text-slate-400 max-w-lg mx-auto">
                    Your reference face embedding and ID document have been submitted and are pending administrative verification review.
                  </p>

                  {ocrResult && (
                    <div className="p-4 rounded-xl bg-[#09090B] border border-[#27272A] text-xs text-left max-w-md mx-auto space-y-1 font-mono">
